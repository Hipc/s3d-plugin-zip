...
public class Zip extends CordovaPlugin {
    ...
    public boolean execute(String action, CordovaArgs args, final CallbackContext callbackContext) throws JSONException {
        if ("unzip".equals(action)) {
            ...
            return true;
        } else if ("unzippass".equals(action)) {
            unzip(args, callbackContext);
            return true;
        }
        return false;
    ...
    private void unzippass(final CordovaArgs args, final CallbackContext callbackContext) {
    ...
    public extractAllFiles(string pathZip, string pathDest, string password) {
        ...
        zipFile.extractAll(pathDest);
    }
    
    private void unzippassSync(CordovaArgs args, CallbackContext callbackContext) {
        try {
            ...
            zipFileName = tempFile.getAbsolutePath();
            ...
            extractAllFiles(zipFileName, outputDir, password); // throws ZipException
